# This formula tracks 1.0.2 branch of OpenSSL, not the 1.1.0 branch.
# This is useful when install legacy versions of other software (such
# as ruby) that do not work with more recent versions of OpenSSL.
